...
export function CancellationsChart({ series, loading }: CancellationsChartProps) {
  if (loading) {
    return (
            ...
            return (
              <div className="rounded-lg border border-border bg-surface-2 px-3 py-2 text-xs shadow-[var(--shadow-elevation-2)]">
                ...
                <p className="mt-1 text-amber-400">
                  {d.Cancelamentos} cancelamento{d.Cancelamentos !== 1 ? "s" : ""}
                </p>
              </div>
            );
          }}
